...
var Module = typeof ZStd !== 'undefined' ? ZStd : {};
...
Module['ready'] = new Promise(function(resolve, reject) {
  ...
  readyPromiseReject = reject;
      ...
      if (!Object.getOwnPropertyDescriptor(Module['ready'], '_ZStdCompress')) {
        Object.defineProperty(Module['ready'], '_ZStdCompress', { configurable: true, get: function() { abort('You are getting _ZStdCompress on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
        Object.defineProperty(Module['ready'], '_ZStdCompress', { configurable: true, set: function() { abort('You are setting _ZStdCompress on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
      }
    

      if (!Object.getOwnPropertyDescriptor(Module['ready'], '_ZStdDecompress')) {
        Object.defineProperty(Module['ready'], '_ZStdDecompress', { configurable: true, get: function() { abort('You are getting _ZStdDecompress on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
        Object.defineProperty(Module['ready'], '_ZStdDecompress', { configurable: true, set: function() { abort('You are setting _ZStdDecompress on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
      }
...
/** @type {function(...*):?} */
var _ZStdCompress = Module["_ZStdCompress"] = createExportWrapper("ZStdCompress");

/** @type {function(...*):?} */
var _ZStdDecompress = Module["_ZStdDecompress"] = createExportWrapper("ZStdDecompress");
